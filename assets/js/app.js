(function () {
  ...
  var LOCALES = {
    fr: {
      ...
      price_notice: "Les prix sont donnés à titre indicatif ; le devis final fait foi.",
      qty_label: "Qté",
      cart_label: "Panier",
      cart_title: "Panier",
    ...
    en: {
      ...
      latest_price_label: "Prices",
      price_unavailable: "Prices unavailable",
      price_notice: "Prices are for reference; final quotation applies.",
      qty_label: "Qty",
      cart_label: "Cart",
      cart_title: "Cart",
    ...
    ar: {
      ...
      latest_price_label: "Prices",
      price_unavailable: "Prices unavailable",
      price_notice: "الأسعار للاسترشاد فقط؛ ويُعتمد عرض السعر النهائي.",
      qty_label: "الكمية",
      cart_label: "السلة",
      cart_title: "السلة",
  ...
  function getCatalog() {
    ...
    return {
      model: {
        name: "JoyMAX",
        motorPicture: "Database/MotorPictures/JoyMAX.png"
      },
      parts: []
    };
  }
  ...
  function submitCart() {
    ...
    var modelName = state.catalog.model.name || "JoyMAX";
